...
python ./scripts/api/history_create_history.py

for file in "$@"; do
    echo "Processing:\t $file"
    python ./scripts/api/upload_data.py --api_key admin --api_url http://localhost:8080 --import_file $file  --library_name Plasmid_Profiler_DB
done
